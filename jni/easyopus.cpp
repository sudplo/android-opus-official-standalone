...
extern "C" JNIEXPORT jint JNICALL
Java_com_theeasiestway_opus_Opus_encoderSetDtx(JNIEnv *env, jobject thiz, jint dtx) {
    return codec.encoderSetDtx(dtx);
}

extern "C" JNIEXPORT jint JNICALL
Java_com_theeasiestway_opus_Opus_encoderSetFec(JNIEnv *env, jobject thiz, jint fec) {
    return codec.encoderSetFec(fec);
}
